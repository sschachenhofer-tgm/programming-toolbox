...
Mit `runLater()` können kleine Aufgaben nebenläufig abgearbeitet werden. Man übergibt der Methode dazu ein `Runnable`-Objekt, das man zum Beispiel mit einer Lambda-Funktion erstellen kann:
